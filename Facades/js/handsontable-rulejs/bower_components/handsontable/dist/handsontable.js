...
DefaultSettings.prototype = {
  ...
  source: void 0,
  title: void 0,
  checkedFacade: void 0,
  uncheckedFacade: void 0,
  format: void 0,
  className: void 0
};
...
(function (Handsontable) {
  ...
  var TextRenderer = function (instance, TD, row, col, prop, value, cellProperties) {
    ...
    if (cellProperties.rendererFacade) {
      Handsontable.Dom.empty(TD);
      var TEMPLATE = document.createElement('TEMPLATE');
      TEMPLATE.setAttribute('bind', '{{}}');
      TEMPLATE.innerHTML = cellProperties.rendererFacade;
      HTMLFacadeElement.decorate(TEMPLATE);
...
(function (Handsontable) {
  ...
  var CheckboxRenderer = function (instance, TD, row, col, prop, value, cellProperties) {
    ...
    if (typeof cellProperties.checkedFacade === "undefined") {
      cellProperties.checkedFacade = true;
    }
    if (typeof cellProperties.uncheckedFacade === "undefined") {
      cellProperties.uncheckedFacade = false;
    }
    ...
    if (value === cellProperties.checkedFacade || value === Handsontable.helper.stringify(cellProperties.checkedFacade)) {
      INPUT.checked = true;
      TD.appendChild(INPUT);
    }
    else if (value === cellProperties.uncheckedFacade || value === Handsontable.helper.stringify(cellProperties.uncheckedFacade)) {
      TD.appendChild(INPUT);
    }
    ...
    if (cellProperties.readOnly) {
      ...
      eventManager.addEventListener(INPUT,'change',function () {
        if (this.checked) {
          instance.setDataAtRowProp(row, prop, cellProperties.checkedFacade);
        }
        else {
          instance.setDataAtRowProp(row, prop, cellProperties.uncheckedFacade);
        }
      });
    }
