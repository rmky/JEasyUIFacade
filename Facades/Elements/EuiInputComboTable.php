...
JS;
     ...
     * @return \exface\JEasyUIFacade\Facades\Elements\EuiInputComboTable
     */
...
JS;
        ...
        $table = $this->getFacade()->getElement($this->getWidget()->getTable());
     ...
     * {@inheritdoc}
     *
     * @see \exface\JEasyUIFacade\Facades\Elements\EuiInput::buildJsInitOptions()
     */
    function buildJsInitOptions()
    {
        /* @var $widget \exface\Core\Widgets\InputComboTable */
        $widget = $this->getWidget();
        /* @var $table \exface\JEasyUIFacade\Facades\Elements\DataTable */
        $table = $this->getFacade()->getElement($widget->getTable());
...
JS;
        ...
        $dataParam = 'currentFilterSet.data = ' . $this->getFacade()->getElement($widget->getTable()->getConfiguratorWidget())->buildJsDataGetter(null, true);
