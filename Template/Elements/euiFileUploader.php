...
class euiFileUploader extends euiAbstractElement
{
    ...
    function generateHtml()
    {
        ...
        $output = <<<HTML
<div id="{$this->getId()}_pastearea" class="fitem exf_input" style="width:{$this->getWidth()};height:{$this->getHeight()};">
...
HTML;
    ...
    $('#{$this->getId()}').fileupload({
        url: 'exface/vendor/exface/JEasyUiTemplate/Template/upload.php?sid={$this->getTemplate()->getWorkbench()->context()->getScopeWindow()->getScopeId()}',
        dataType: 'json',
        autoUpload: true,
