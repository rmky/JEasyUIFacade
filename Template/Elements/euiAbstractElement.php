...
abstract class euiAbstractElement {
	...
	public function get_js_value_getter(){
		return '$("#' . $this->get_id() . '").' . $this->get_js_value_getter_method();
	}
	 ...
	 * needs to specifiy an element id explicitly - otherwise go for get_js_value_getter() which includes the id of the element.
	 * @see get_js_value_getter()
	 * @return string
	 */
	 ...
	 * get_js_value_getter()) or an anonymous function.
	 * @param string $value
	 * @return string
	 */
	function get_js_value_setter($value){
		return '$("#' . $this->get_id() . '").' . $this->get_js_value_setter_method($value);
	}
	 ...
	 * needs to specifiy an element id explicitly - otherwise go for get_js_value_setter() which includes the id of the element.
	 * @see get_js_value_getter()
	 * @return string
	 */
	...
	public function get_js_data_getter($include_inactive_data = false){
		...
		$output = "[{" . $alias . ": " . $this->get_js_value_getter() . "}]";
		return $output;
	}
