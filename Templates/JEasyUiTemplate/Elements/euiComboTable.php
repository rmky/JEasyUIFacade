...
class euiComboTable extends euiInput
{
     ...
     * {@inheritdoc}
     *
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiInput::init()
     */
...
JS;
     ...
     * @return \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiComboTable
     */
     ...
     * {@inheritdoc}
     *
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiInput::buildHtml()
     */
    function buildHtml()
    {
...
HTML;
     ...
     * {@inheritdoc}
     *
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiInput::buildJs()
     */
    function buildJs()
    {
...
JS;
     ...
     * {@inheritdoc}
     *
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiInput::buildJsInitOptions()
     */
    function buildJsInitOptions()
    {
        /* @var $widget \exface\Core\Widgets\ComboTable */
        $widget = $this->getWidget();
        /* @var $table \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\DataTable */
