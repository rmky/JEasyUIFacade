...
JS;
    ...
    public function buildHtmlHeadTags()
    {
        ...
        $includes[] = '<script type="text/javascript" src="exface/vendor/exface/JEasyUiTemplate/Templates/JEasyUiTemplate/js/flot/plugins/axislabels/jquery.flot.axislabels.js"></script>';
        $includes[] = '<script type="text/javascript" src="exface/vendor/exface/JEasyUiTemplate/Templates/JEasyUiTemplate/js/flot/plugins/jquery.flot.orderBars.js"></script>';
