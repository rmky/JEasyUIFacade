...
class euiDataTable extends euiData
{
     ...
     * 
     * {@inheritDoc}
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiData::init()
     */
     ...
     * 
     * {@inheritDoc}
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiData::buildHtml()
     */
...
HTML;
     ...
     * 
     * {@inheritDoc}
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiData::buildJs()
     */
...
JS;
     ...
     * 
     * {@inheritDoc}
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiData::buildHtmlHeadTags()
     */
    public function buildHtmlHeadTags()
    {
        ...
        if ($this->getWidget()->hasRowDetails()) {
            $includes[] = '<script type="text/javascript" src="exface/vendor/exface/JEasyUiTemplate/Templates/JEasyUiTemplate/js/jeasyui/extensions/datagridview/datagrid-detailview.js"></script>';
        }
        if ($this->getWidget()->hasRowGroups()){
            $includes[] = '<script type="text/javascript" src="exface/vendor/exface/JEasyUiTemplate/Templates/JEasyUiTemplate/js/jeasyui/extensions/datagridview/datagrid-groupview.js"></script>';
        }
        return $includes;
    }
     ...
     * {@inheritdoc}
     *
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiAbstractElement::getHeight()
     */
     ...
     * 
     * {@inheritDoc}
     * @see \exface\JEasyUiTemplate\Templates\JEasyUiTemplate\Elements\euiData::buildJsInitOptionsColumn()
     */
