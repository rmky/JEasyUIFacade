...
{    
    ...
    function buildHtmlHeadTags()
    {
        // handsontable
        $includes = array(
            '<script src="exface/vendor/exface/JEasyUiTemplate/Templates/js/handsontable-rulejs/bower_components/handsontable/dist/handsontable.full.min.js"></script>',
            '<link rel="stylesheet" media="screen" href="exface/vendor/exface/JEasyUiTemplate/Templates/js/handsontable-rulejs/bower_components/handsontable/dist/handsontable.full.min.css">'
        );
        // formula suppoert
        if ($this->getWidget()->getFormulasEnabled()) {
            $includes[] = '<link rel="stylesheet" media="screen" href="exface/vendor/exface/JEasyUiTemplate/Templates/js/handsontable-rulejs/src/handsontable.formula.css">';
            $includes[] = '<script type="text/javascript" src="exface/vendor/exface/JEasyUiTemplate/Templates/js/handsontable-rulejs/bower_components/ruleJS/dist/full/ruleJS.all.full.min.js"></script>';
            $includes[] = '<script type="text/javascript" src="exface/vendor/exface/JEasyUiTemplate/Templates/js/handsontable-rulejs/src/handsontable.formula.js"></script>';
...
HTML;
     ...
     *
     * @see \exface\JEasyUiTemplate\Templates\Elements\grid::buildJsInitOptionsColumns()
     */
     ...
     *
     * @see \exface\JEasyUiTemplate\Templates\Elements\grid::buildJsDataSource()
     */
